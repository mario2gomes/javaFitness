...
<body>
	...
	<h1 align="center"><a><button>Cordenacao</button></a><br></h1>	
			
	<form action="controle" method="post">
	<h3 align="center">Matrícula: <input type="text" name="matricula"></h3>
	<h3 align="center">Senha: <input type="password" name="senha"></h3>
        <input type="hidden" value="cordenacao" name="modo"/>
